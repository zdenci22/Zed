...
var MANIFEST = {
  ...
  name: "Zed Movie Addon",
  description: "Addon for Everyone",
  ...
  catalogs: [
    { type: "movie", id: "Zed Movie" },
    { type: "series", id: "Zed Show" }
  ],
...
var METAHUB_URL = 'https://raw.githubusercontent.com/zdenci22/Zed/refs/heads/main/pictures/1.jpg';
...
if (module.parent) {
  ...
  addon.listen(6666, function () {
    console.log('Add-on Repository URL: http://127.0.0.1:6666/manifest.json');
  });
}
